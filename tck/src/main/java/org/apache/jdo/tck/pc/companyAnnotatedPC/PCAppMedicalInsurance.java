...
public class PCAppMedicalInsurance extends PCAppInsurance implements IMedicalInsurance {
  ...
  /**
   * Construct a <code>PCAppMedicalInsurance</code> instance.
   *
   * @param insid The insurance instance identifier.
   * @param carrier The insurance carrier.
   * @param planType The planType.
   */
  public PCAppMedicalInsurance(long insid, String carrier, String planType) {
    super(insid, carrier);
   ...
   * @param planType The planType.
   */
  public PCAppMedicalInsurance(long insid, String carrier, IEmployee employee, String planType) {
  ...
  /**
   * Returns a String representation of a <code>PCAppMedicalInsurance</code> object.
   *
   * @return a String representation of a <code>PCAppMedicalInsurance</code> object.
   */
  @Override
