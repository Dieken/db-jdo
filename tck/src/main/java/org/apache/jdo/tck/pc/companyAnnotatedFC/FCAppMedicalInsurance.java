...
public class FCAppMedicalInsurance extends FCAppInsurance implements IMedicalInsurance {
   ...
   */
  public FCAppMedicalInsurance() {}

  /**
   * Construct a <code>FCAppMedicalInsurance</code> instance.
   *
   * @param insid The insurance instance identifier.
   * @param carrier The insurance carrier.
   * @param planType The planType.
   */
  public FCAppMedicalInsurance(long insid, String carrier, String planType) {
    super(insid, carrier);
   ...
   * @param planType The planType.
   */
  public FCAppMedicalInsurance(long insid, String carrier, IEmployee employee, String planType) {
  ...
  /**
   * Returns a String representation of a <code>FCAppMedicalInsurance</code> object.
   *
   * @return a String representation of a <code>FCAppMedicalInsurance</code> object.
   */
  @Override
  ...
  public boolean deepCompareFields(Object other, EqualityHelper helper) {
    FCAppMedicalInsurance otherIns = (FCAppMedicalInsurance) other;
