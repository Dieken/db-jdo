...
public class PCAppFullTimeEmployee extends PCAppEmployee implements IFullTimeEmployee {

  private static final long serialVersionUID = 1L;

  @NotPersistent() private double _salary;
   ...
   * fields of the specified PCAppFullTimeEmployee.
   *
