...
public class FCDSProject
  ...
  @Element(
      types = org.apache.jdo.tck.pc.companyAnnotatedFC.FCDSEmployee.class,
      column = "REVIEWER",
   ...
   *
   * @return The members of the project is returned as an unmodifiable set of <code>FCDSEmployee
   *     </code>s.
   */
  ...
  /**
   * Compares this object with the specified FCDSProject object for order. Returns a negative
   ...
   *     or greater than the specified FFCDSProject object.
   */
  ...
  /**
   * This class is used to represent the application identity for the <code>FCDSProject</code>
   * class.
   */
  public static class Oid implements Serializable, Comparable<Oid> {
    ...
    /**
     * This field represents the identifier for the <code>FCDSProject</code> class. It must match a
     * field in the <code>FCDSProject</code> class in both name and type.
     */
    public long projid;
