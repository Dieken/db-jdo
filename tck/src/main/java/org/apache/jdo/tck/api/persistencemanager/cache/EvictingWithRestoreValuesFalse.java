 ...
 * <B>Assertion ID:</B> A12.6.1-1. <br>
 * <B>Assertion Description: </B> If users wish to automatically <code>evict</code> transactional
 * instances at transaction <code>rollback</code> time, then they should set <code>RestoreValues
 * </code> to <code>false</code>. For each persistent-clean instance that the JDO <code>
 * PersistenceManager</code> evicts, it:
 *
 * <UL>
