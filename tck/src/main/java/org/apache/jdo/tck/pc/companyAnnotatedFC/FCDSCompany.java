...
public class FCDSCompany
  ...
  /**
   * Initialize the <code>FCDSCompany</code> instance.
   *
   * @param companyid The company id.
   * @param name The company name.
   * @param founded The date the company was founded.
   */
  public FCDSCompany(long companyid, String name, Date founded) {
   ...
   */
  public FCDSCompany(long companyid, String name, Date founded, IAddress addr) {
    this(companyid, name, founded);
    this.address = (FCDSAddress) addr;
  }
   ...
   *
   * @return An unmodifiable <code>Set</code> that contains all the <code>FCDSDepartment</code>s of
   *     the company.
   */
  ...
  /**
   * Add a <code>FCDSDepartment</code> instance to the company.
   *
   * @param dept The <code>FCDSDepartment</code> instance to add.
   */
  public void addDepartment(FCDSDepartment dept) {
    departments.add(dept);
  }

  /**
   * Remove a <code>FCDSDepartment</code> instance from the company.
   *
   * @param dept The <code>FCDSDepartment</code> instance to remove.
   */
  public void removeDepartment(FCDSDepartment dept) {
    departments.remove(dept);
  }

  /**
   * Initialize the set of <code>FCDSDepartment</code>s in the company to the parameter.
   *
   * @param departments The set of <code>FCDSDepartment</code>s for the company.
   */
  ...
  public boolean deepCompareFields(Object other, EqualityHelper helper) {
    FCDSCompany otherCompany = (FCDSCompany) other;
  ...
  public boolean equals(Object obj) {
    if (obj instanceof FCDSCompany) {
      return compareTo((FCDSCompany) obj) == 0;
    }
    return false;
  }
