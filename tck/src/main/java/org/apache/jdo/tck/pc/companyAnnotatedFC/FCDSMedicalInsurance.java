...
public class FCDSMedicalInsurance extends FCDSInsurance implements IMedicalInsurance {
   ...
   */
  public FCDSMedicalInsurance(long insid, String carrier, String planType) {
    super(insid, carrier);
   ...
   * @param planType The planType.
   */
  public FCDSMedicalInsurance(long insid, String carrier, FCDSEmployee employee, String planType) {
  ...
  /**
   * Returns a String representation of a <code>FCDSMedicalInsurance</code> object.
   *
   * @return a String representation of a <code>FCDSMedicalInsurance</code> object.
   */
  @Override
