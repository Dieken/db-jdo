...
public class PCDSProject
   ...
   *
   * @return The members of the project is returned as a set of <code>PCDSEmployee</code>s.
   */
  ...
  /**
   * Compares this object with the specified PCDSProject object for order. Returns a negative
   ...
   *     or greater than the specified PCDSProject object.
   */
  ...
  /**
   * This class is used to represent the application identity for the <code>PCDSProject</code>
   * class.
   */
  public static class Oid implements Serializable, Comparable<Oid> {
    ...
    /**
     * This field represents the identifier for the <code>PCDSProject</code> class. It must match a
     * field in the <code>PCDSProject</code> class in both name and type.
     */
    public long projid;
