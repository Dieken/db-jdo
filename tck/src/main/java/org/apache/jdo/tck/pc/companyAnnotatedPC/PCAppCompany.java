...
public class PCAppCompany
  ...
  @NotPersistent() private transient Set<IDepartment> _departments = new HashSet<>();
  ...
  /**
   * Initialize the set of <code>PCAppDepartment</code>s in the company to the parameter.
   *
   * @param departments The set of <code>PCAppDepartment</code>s for the company.
   */
