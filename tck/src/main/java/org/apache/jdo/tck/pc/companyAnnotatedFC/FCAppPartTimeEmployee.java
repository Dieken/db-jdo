...
public class FCAppPartTimeEmployee extends FCAppEmployee implements IPartTimeEmployee {
  ...
  /**
   * Returns a String representation of a <code>FCAppPartTimeEmployee</code> object.
   *
   * @return a String representation of a <code>FCAppPartTimeEmployee</code> object.
   */
  @Override
   ...
   * fields of the specified FCAppPartTimeEmployee.
   *
  ...
  public boolean deepCompareFields(Object other, EqualityHelper helper) {
    FCAppPartTimeEmployee otherEmp = (FCAppPartTimeEmployee) other;
