...
public class PCAppDentalInsurance extends PCAppInsurance implements IDentalInsurance {
   ...
   */
  public PCAppDentalInsurance(long insid, String carrier, BigDecimal lifetimeOrthoBenefit) {
    super(insid, carrier);
  ...
  /**
   * Returns a String representation of a <code>PCAppDentalInsurance</code> object.
   *
   * @return a String representation of a <code>PCAppDentalInsurance</code> object.
   */
  @Override
