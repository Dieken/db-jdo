...
public abstract class PCAppEmployee extends PCAppPerson implements IEmployee {
  ...
  @NotPersistent() private Date _hiredate;
  @NotPersistent() private double _weeklyhours;
  @NotPersistent() private PCAppDentalInsurance _dentalInsurance;
  @NotPersistent() private PCAppMedicalInsurance _medicalInsurance;
  @NotPersistent() private PCAppDepartment _department;
  @NotPersistent() private PCAppDepartment _fundingDept;
  @NotPersistent() private PCAppEmployee _manager;
  @NotPersistent() private PCAppEmployee _mentor;
  @NotPersistent() private PCAppEmployee _protege;
  @NotPersistent() private PCAppEmployee _hradvisor;
  @NotPersistent() private transient Set<IProject> _reviewedProjects = new HashSet<>();
  @NotPersistent() private transient Set<IProject> _projects = new HashSet<>();
  @NotPersistent() private transient Set<IEmployee> _team = new HashSet<>();
  @NotPersistent() private transient Set<IEmployee> _hradvisees = new HashSet<>();
  ...
  public void setReviewedProjects(Set<IProject> reviewedProjects) {
    ...
    this._reviewedProjects = (reviewedProjects != null) ? new HashSet<>(reviewedProjects) : null;
  }

  /**
   * Get the employee's projects.
   *
   * @return The employee's projects set.
   */
  ...
  /**
   * Add an <code>PCAppEmployee</code> to this employee's team. This method sets both sides of the
  ...
  /**
   * Remove an <code>PCAppEmployee</code> from this employee's team. This method will also set the
  ...
  /**
   * Add an <code>PCAppEmployee</code> as an advisee of this HR advisor. This method also sets the
  ...
  /**
   * Remove an <code>PCAppEmployee</code> as an advisee of this HR advisor. This method also sets
   ...
   *
   * @param hradvisees The <code>PCAppEmployee</code>s that are HR advisees of this employee.
   */
   ...
   * corresponding fields of the specified PCAppEmployee.
   *
  ...
  public boolean deepCompareFields(Object other, EqualityHelper helper) {
    ...
    return super.deepCompareFields(otherEmp, helper)
        ...
        & helper.deepEquals(
            _dentalInsurance, otherEmp.getDentalInsurance(), where + ".dentalInsurance")
        & helper.deepEquals(
            _medicalInsurance, otherEmp.getMedicalInsurance(), where + ".medicalInsurance")
        ...
        & helper.deepEquals(
            _reviewedProjects, otherEmp.getReviewedProjects(), where + ".reviewedProjects")
