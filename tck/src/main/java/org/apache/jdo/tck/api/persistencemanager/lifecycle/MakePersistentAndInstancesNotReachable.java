...
/**
 * <B>Title:</B> MakePersistent And Instances Not Reachable <br>
 * <B>Keywords:</B> <br>
 * <B>Assertion ID:</B> A12.5.7-6C. <br>
 * <B>Assertion Description: </B> When calling <code>PersistenceManager.makePersistent</code> or
 * <code>makePersistentAll</code>, transient instances will become persistent and any transient
 * instances reachable via persistent fields will become provisionally persistent. That is, they
 * behave as persistent-new instances (return true to isPersistent, isNew, and isDirty). But at
 * commit time, the reachability algorithm is run again, and instances made provisionally persistent
 * that are not currently reachable from persistent instances will revert to transient.
 */
