...
public class FCDSDentalInsurance extends FCDSInsurance implements IDentalInsurance {
   ...
   */
  public FCDSDentalInsurance(long insid, String carrier, BigDecimal lifetimeOrthoBenefit) {
    super(insid, carrier);
    this.lifetimeOrthoBenefit = lifetimeOrthoBenefit;
  }

  /**
   * Construct a <code>FCDSDentalInsurance</code> instance.
   *
   * @param insid The insurance instance identifier.
   * @param carrier The insurance carrier.
   ...
   */
  public FCDSDentalInsurance(
      long insid, String carrier, FCDSEmployee employee, BigDecimal lifetimeOrthoBenefit) {
  ...
  /**
   * Returns a String representation of a <code>FCDSDentalInsurance</code> object.
   *
   * @return a String representation of a <code>FCDSDentalInsurance</code> object.
   */
  @Override
