...
public class PCDSPerson
   ...
   * fields of the specified PCDSPerson.
   *
  ...
  /**
   * Compares this object with the specified PCDSPerson object for order. Returns a negative
   ...
   *     or greater than the specified PCDSPerson object.
   */
