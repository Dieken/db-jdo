...
public class FCAppDepartment
   ...
   */
  public FCAppDepartment(long deptid, String name) {
    this.deptid = deptid;
    this.name = name;
  }
   ...
   */
  public FCAppDepartment(long deptid, String name, ICompany company) {
    this.deptid = deptid;
    this.name = name;
    this.company = (FCAppCompany) company;
  }
   ...
   */
  public FCAppDepartment(long deptid, String name, ICompany company, IEmployee employeeOfTheMonth) {
    this.deptid = deptid;
    this.name = name;
    this.company = (FCAppCompany) company;
    this.employeeOfTheMonth = (FCAppEmployee) employeeOfTheMonth;
  }
   ...
   */
  public void addEmployee(FCAppEmployee emp) {
    employees.add(emp);
  }
   ...
   */
  public void removeEmployee(FCAppEmployee emp) {
   ...
   * @param emp The employee to add to the department.
   */
  public void addFundedEmp(FCAppEmployee emp) {
    fundedEmps.add(emp);
  }
   ...
   * @param emp The employee to remove from the department.
   */
  public void removeFundedEmp(FCAppEmployee emp) {
   ...
   * fields of the other FCAppDepartment.
   *
  ...
  public boolean deepCompareFields(Object other, EqualityHelper helper) {
    FCAppDepartment otherDept = (FCAppDepartment) other;
  ...
  /**
   * Returns a String representation of a <code>FCAppDepartment</code> object.
   *
   * @return a String representation of a <code>FCAppDepartment</code> object.
   */
  ...
  public boolean equals(Object obj) {
    if (obj instanceof FCAppDepartment) {
      return compareTo((FCAppDepartment) obj) == 0;
    }
    return false;
  }
