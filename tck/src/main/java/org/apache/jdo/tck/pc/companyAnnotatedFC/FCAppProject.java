...
public class FCAppProject
  ...
  @Element(
      types = org.apache.jdo.tck.pc.companyAnnotatedFC.FCAppEmployee.class,
      column = "REVIEWER")
   ...
   */
  public FCAppProject(long projid, String name, BigDecimal budget) {
    this.projid = projid;
    this.name = name;
    this.budget = budget;
  }
   ...
   */
  public void addReviewer(FCAppEmployee emp) {
    reviewers.add(emp);
  }
   ...
   */
  public void removeReviewer(FCAppEmployee emp) {
   ...
   *
   * @return The members of the project is returned as an unmodifiable set of <code>FCAppEmployee
   *     </code>s.
   */
   ...
   */
  public void addMember(FCAppEmployee emp) {
    members.add(emp);
  }
   ...
   */
  public void removeMember(FCAppEmployee emp) {
    members.remove(emp);
  }
  ...
  /**
   * Returns a String representation of a <code>FCAppProject</code> object.
   *
   * @return a String representation of a <code>FCAppProject</code> object.
   */
  ...
  public boolean deepCompareFields(Object other, EqualityHelper helper) {
    FCAppProject otherProject = (FCAppProject) other;
  ...
  /**
   * Compares this object with the specified FCAppProject object for order. Returns a negative
   * integer, zero, or a positive integer as this object is less than, equal to, or greater than the
   * specified object.
   *
   * @param other The FCAppProject object to be compared.
   * @return a negative integer, zero, or a positive integer as this object is less than, equal to,
   *     or greater than the specified FFCAppProject object.
   */
  ...
  public boolean equals(Object obj) {
    if (obj instanceof FCAppProject) {
      return compareTo((FCAppProject) obj) == 0;
    }
    return false;
  }
  ...
  /**
   * This class is used to represent the application identity for the <code>FCAppProject</code>
   * class.
   */
  public static class Oid implements Serializable, Comparable<Oid> {
    ...
    /**
     * This field represents the identifier for the <code>FCAppProject</code> class. It must match a
     * field in the <code>FCAppProject</code> class in both name and type.
     */
    public long projid;
