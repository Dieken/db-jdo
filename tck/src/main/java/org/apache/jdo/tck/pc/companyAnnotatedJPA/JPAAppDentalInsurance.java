 ...
 */
@Entity
public class JPAAppDentalInsurance extends JPAAppInsurance implements IDentalInsurance {
   ...
   */
  public JPAAppDentalInsurance(long insid, String carrier, BigDecimal lifetimeOrthoBenefit) {
    super(insid, carrier);
  ...
  /**
   * Returns a String representation of a <code>JPAAppDentalInsurance</code> object.
   *
   * @return a String representation of a <code>JPAAppDentalInsurance</code> object.
   */
  @Override
