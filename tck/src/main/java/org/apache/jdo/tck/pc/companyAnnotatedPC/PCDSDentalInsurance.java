...
public class PCDSDentalInsurance extends PCDSInsurance implements IDentalInsurance {

  private static final long serialVersionUID = 1L;

  @NotPersistent() private BigDecimal _lifetimeOrthoBenefit;
   ...
   */
  public PCDSDentalInsurance(long insid, String carrier, BigDecimal lifetimeOrthoBenefit) {
    super(insid, carrier);
   ...
   */
  public PCDSDentalInsurance(
      long insid, String carrier, PCDSEmployee employee, BigDecimal lifetimeOrthoBenefit) {
  ...
  /**
   * Returns a String representation of a <code>PCDSDentalInsurance</code> object.
   *
   * @return a String representation of a <code>PCDSDentalInsurance</code> object.
   */
  @Override
