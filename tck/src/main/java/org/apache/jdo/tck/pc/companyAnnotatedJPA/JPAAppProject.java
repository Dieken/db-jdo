...
public class JPAAppProject
   ...
   *
   * @return The members of the project is returned as an unmodifiable set of <code>JPAAppEmployee
   *     </code>s.
   */
  ...
  /**
   * Compares this object with the specified JPAAppProject object for order. Returns a negative
   ...
   *     or greater than the specified JPAAppProject object.
   */
  ...
  /**
   * This class is used to represent the application identity for the <code>JPAAppProject</code>
   * class.
   */
  public static class Oid implements Serializable, Comparable<Oid> {
    ...
    /**
     * This field represents the identifier for the <code>JPAAppProject</code> class. It must match
     * a field in the <code>JPAAppProject</code> class in both name and type.
     */
    public long projid;
