...
/**
 * <B>Title:</B> Get Object By Id With Validation, Instance Not in Cache, Not in Datastore <br>
 * <B>Keywords:</B> exception <br>
 * <B>Assertion IDs:</B> A12.6.5-2. <br>
 * <B>Assertion Description: </B> Object getObjectById (Object oid, boolean validate) with
 * validate==true. If the instance does not exist in the datastore, then a
 * JDOObjectNotFoundException is thrown.
 */
public class GetObjectByIdWithValidationInstanceNotInCacheNotInDatastore
