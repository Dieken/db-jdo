...
/**
 * <B>Title:</B> Non-persistent Super Class <br>
 * <B>Keywords:</B> inheritance <br>
 * <B>Assertion ID:</B> A6.5-1. <br>
 * <B>Assertion Description: </B> A class might be persistence-capable even if its superclass is not
 * persistence-capable.
 */
