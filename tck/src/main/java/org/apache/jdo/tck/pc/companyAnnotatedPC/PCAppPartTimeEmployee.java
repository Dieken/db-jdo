...
public class PCAppPartTimeEmployee extends PCAppEmployee implements IPartTimeEmployee {
  ...
  /**
   * Returns a String representation of a <code>PCAppPartTimeEmployee</code> object.
   *
   ...
   * fields of the specified PCAppPartTimeEmployee.
   *
