...
public class JPAAppMedicalInsurance extends JPAAppInsurance implements IMedicalInsurance {
   ...
   */
  public JPAAppMedicalInsurance(long insid, String carrier, String planType) {
    super(insid, carrier);
   ...
   * @param planType The planType.
   */
  public JPAAppMedicalInsurance(long insid, String carrier, IEmployee employee, String planType) {
  ...
  /**
   * Returns a String representation of a <code>JPAAppMedicalInsurance</code> object.
   *
   * @return a String representation of a <code>JPAAppMedicalInsurance</code> object.
   */
  @Override
