...
public class JPAAppCompany
   ...
   *
   * @return An unmodifiable <code>Set</code> that contains all the <code>JPAAppDepartment</code>s
   *     of the company.
   */
  ...
  /**
   * Initialize the set of <code>JPAAppDepartment</code>s in the company to the parameter.
   *
   * @param departments The set of <code>JPAAppDepartment</code>s for the company.
   */
