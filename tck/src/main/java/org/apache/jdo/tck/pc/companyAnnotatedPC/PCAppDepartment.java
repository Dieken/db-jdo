...
public class PCAppDepartment
  ...
  @NotPersistent() private PCAppCompany _company;
  @NotPersistent() private PCAppEmployee _employeeOfTheMonth;
   ...
   */
  public PCAppDepartment(long deptid, String name, ICompany company, IEmployee employeeOfTheMonth) {
    this._deptid = deptid;
    this._name = name;
    this._company = (PCAppCompany) company;
   ...
   * fields of the other PCAppDepartment.
   *
