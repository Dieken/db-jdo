...
public class FCAppAddress
  ...
  /**
   * This constructor initializes the <code>FCAppAddress</code> components.
   *
  ...
  public boolean deepCompareFields(Object other, EqualityHelper helper) {
    FCAppAddress otherAddress = (FCAppAddress) other;
  ...
  /**
   * Compares its two FCAppAddress arguments for order. Returns a negative integer, zero, or a
   * positive integer as the first argument is less than, equal to, or greater than the second.
   *
   * @param o1 the firstFCAppAddresss object to be compared.
  ...
  public boolean equals(Object obj) {
    if (obj instanceof FCAppAddress) {
      return compareTo((FCAppAddress) obj) == 0;
    }
    return false;
  }
