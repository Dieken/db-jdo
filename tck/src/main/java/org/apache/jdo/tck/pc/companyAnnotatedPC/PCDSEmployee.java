...
public abstract class PCDSEmployee extends PCDSPerson implements IEmployee {
  ...
  @NotPersistent() private PCDSDentalInsurance _dentalInsurance;
  @NotPersistent() private PCDSMedicalInsurance _medicalInsurance;
  @NotPersistent() private PCDSDepartment _department;
  @NotPersistent() private PCDSDepartment _fundingDept;
  @NotPersistent() private PCDSEmployee _manager;
  @NotPersistent() private PCDSEmployee _mentor;
  @NotPersistent() private PCDSEmployee _protege;
  @NotPersistent() private PCDSEmployee _hradvisor;
  ...
  /**
   * Add an <code>PCDSEmployee</code> to this employee's team. This method sets both sides of the
  ...
  /**
   * Remove an <code>PCDSEmployee</code> from this employee's team. This method will also set the
  ...
  /**
   * Add an <code>PCDSEmployee</code> as an advisee of this HR advisor. This method also sets the
  ...
  /**
   * Remove an <code>PCDSEmployee</code> as an advisee of this HR advisor. This method also sets the
   ...
   *
   * @param hradvisees The <code>PCDSEmployee</code>s that are HR advisees of this employee.
   */
   ...
   * corresponding fields of the specified PCDSEmployee.
   *
