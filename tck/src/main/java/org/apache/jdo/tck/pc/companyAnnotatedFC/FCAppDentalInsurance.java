...
public class FCAppDentalInsurance extends FCAppInsurance implements IDentalInsurance {
   ...
   */
  public FCAppDentalInsurance(long insid, String carrier, BigDecimal lifetimeOrthoBenefit) {
    super(insid, carrier);
  ...
  /**
   * Returns a String representation of a <code>FCAppDentalInsurance</code> object.
   *
   * @return a String representation of a <code>FCAppDentalInsurance</code> object.
   */
  @Override
