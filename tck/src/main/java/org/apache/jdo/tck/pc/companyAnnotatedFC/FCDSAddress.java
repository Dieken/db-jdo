...
public class FCDSAddress
  ...
  /**
   * This constructor initializes the <code>FCDSAddress</code> components.
   *
  ...
  public boolean deepCompareFields(Object other, EqualityHelper helper) {
    FCDSAddress otherAddress = (FCDSAddress) other;
  ...
  /**
   * Compares its two FCDSAddress arguments for order. Returns a negative integer, zero, or a
   * positive integer as the first argument is less than, equal to, or greater than the second.
   *
   * @param o1 the first FCDSAddress object to be compared.
   * @param o2 the second FFCDSAddressobject to be compared.
  ...
  public boolean equals(Object obj) {
    if (obj instanceof FCDSAddress) {
      return compareTo((FCDSAddress) obj) == 0;
    }
    return false;
  }
